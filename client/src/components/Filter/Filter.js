...
function Filter({ sort, handleSort, setPriceRange, setLtORgt, ltORgt, handlePriceRange, handleFilters, filters }) {
          ...
          <div className="mt-4 mb-4">
            <TextField
              ...
              onChange={(e) => {
                ...
                (inputValue >= 0) ? setPriceRange(inputValue) : setPriceRange(0);
              }}
            /> 
            <FormControlLabel
              control={
