...
const Cart = ({ history }) => {
  ...
  return (
    <>
              ...
              {cartItems.map((item) => (
                <ListGroup.Item key={item.productId}>
                  <Row>
                    ...
                    <Col>
                      <Button type="button" variant="light" onClick={() => dispatch(removeItemFromCart(item.productId))}>
      ...
      {!cartItems.length && <Image src="/uploads/empty_cart.svg" style={{width: '50%', height: 'auto'}}/>}
    </>
  );
};
